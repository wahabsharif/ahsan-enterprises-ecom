...
// internal
import logo from "@assets/img/logo/ae-logo.svg";
                ...
                <div className="tp-footer-widget footer-col-1 mb-50">
                  <div className="tp-footer-widget-content">
                    ...
                    <p className="tp-footer-desc">
                      We are the authorized distributor for MOEL, DELONGHI, and
                      RINNAI brands in Pakistan.
                    </p>
                ...
                <div className="tp-footer-widget footer-col-4 mb-50">
                  ...
                  <div className="tp-footer-widget-content">
                    <div className="tp-footer-talk mb-20">
                      ...
                      <h4>
                        <a href="tel:+923125205301">+92 312 520 5301</a>
                      </h4>
                    </div>
                    <div className="tp-footer-contact">
                      <div className="tp-footer-contact-item d-flex align-items-start">
                        ...
                        <div className="tp-footer-contact-content">
                          <p>
                            <a href="mailto:ahsansenterprises@gmail.com">
                              ahsansenterprises@gmail.com
                            </a>
                          </p>
                        </div>
                      </div>
                ...
                <div className="col-md-6">
                  <div className="tp-footer-copyright">
                    <p>
                      ...
                      Designed & Developed by BeaconTechh With
                      <Link href="https://beacontechh.com/" target="_blank">
                        {" "}
                        ❤
                      </Link>
                      .
